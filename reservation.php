...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmer'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO reservations (utilisateur_id, chambre_id, date_debut, date_fin, statut) VALUES (?, ?, ?, ?, 'en_attente')");
    $stmt->execute([$utilisateur_id, $chambre_id, $date_debut, $date_fin]);

    header("Location: confirmation.php?chambre_id=$chambre_id&debut=$date_debut&fin=$date_fin");
    exit;
}
?>
...
<div class="confirmation-container">
    <div class="confirmation-header">
        ...
        <p>Veuillez vérifier les détails de votre réservation avant de confirmer</p>
    </div>
    ...
    <form method="post">
        <div class="btn-group">
            <button type="submit" name="confirmer" class="btn btn-primary">
                <i class="fas fa-check-circle"></i> Confirmer la Réservation
            </button>
            <a href="chambre.php" class="btn btn-secondary">
